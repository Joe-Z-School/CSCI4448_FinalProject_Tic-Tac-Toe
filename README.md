...
* Factory Pattern:
    - The factory pattern will be used in the creation of the different types of players and movements present in the game. A PlayerFactory class will be utilized to create and pass player objects to the abstract Player class.
* Observer Pattern:
